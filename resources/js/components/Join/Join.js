    ...
    return (
      <div className = "joinOuterContainer">   
          <div className = "joinInnerContainer">  
            <h1 className ="heading" style={{color:"black"}}>LIVE CHAT SUPPORT <i class="fas fa-comments fa-2x"></i></h1>
            ...
            */}
            <Link onClick ={event => (!name || !room) ? event.preventDefault() : null} to ={`/chat?name=${name}&room=${room}`}>
                <button className = "button mt-20" type="submit">Join Lunamar Chat</button>  {/*This button is used to sign in*/}
            </Link>  
          </div> 
